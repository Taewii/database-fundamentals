...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<ProductsInRangeDto> productsInRange(int lower, int upper) {
        return this.productRepository.productsInRange(new BigDecimal(lower), new BigDecimal(upper));
    }
}