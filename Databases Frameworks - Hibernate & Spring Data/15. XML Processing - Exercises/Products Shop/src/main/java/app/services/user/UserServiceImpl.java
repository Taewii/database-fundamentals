...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<User> usersWithAtleastOneProductSold() {
		return this.userRepository.usersWithAtleastOneProductSold();
	}

	@Override
	public List<SuccessfulUserDto> usersWithAtleastOneProductSoldDto() {
